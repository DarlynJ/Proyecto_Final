...
<?php if ($user->profile_image): ?>
    ...
    <div>
    <a  class="button is-danger is-light" href="<?= site_url("/profileimage/delete") ?>"><?= lang('Profile.deleteimage') ?></a>
    </div>
...
<a class="button is-link" href="<?= site_url("/profile/editpassword") ?>"><?= lang('Profile.changepass') ?></a>
<a class="button is-link" href="<?= site_url("/profileimage/edit") ?>"><?= lang('Profile.changepro') ?></a>
